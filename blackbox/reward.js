...
(function() {
  ...
  libReward.getRewardModifier = function(type) {
  ...
  libReward.generateReward = function(config, dropInfo, rand) {
    var res;
    if (!rand) {
      rand = Math.random;
    }
  ...
  libReward.generateDungeonReward = function(dungeon) {
  ...
  libReward.claimDungeonReward = function(dungeon, isSweep) {
