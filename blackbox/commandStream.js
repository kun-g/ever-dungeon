...
(function() {
  ...
  libCommandStream.Command = Command;

  libCommandStream.makeCommand = makeCommand;

  libCommandStream.command_config = command_config;

  libCommandStream.installCommandExtention = function(obj) {
