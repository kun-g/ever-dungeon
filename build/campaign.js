(function() {
  ...
  Campaign = (function() {
    ...
    Campaign.prototype.update = function(object) {
      var thisData, _base;
      thisData = {
        object: object
      };
      return typeof (_base = this.config).update === "function" ? _base.update(thisData, utils) : void 0;
    };

    Campaign.prototype.activate = function() {
      var delta, object, thisData, time, _base;
      object = arguments[0];
      delta = arguments[1];
      time = arguments[2];
      ...
      object.counters[this.config.counter.key].incr(delta, time);
      thisData = {
        object: object
      };
      return typeof (_base = this.config).activate === "function" ? _base.activate(thisData, utils) : void 0;
    };
